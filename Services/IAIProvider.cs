...
namespace TagForge.Services
{
    public interface IAIProvider
    {
        ...
        /// </summary>
        Task<string> GenerateAsync(string systemPrompt, string userPrompt, string model, string apiKey, string baseUrl, string? imagePath = null, System.Threading.CancellationToken cancellationToken = default, System.Action<string, string, bool>? logger = null);
        ...
        /// </summary>
        IAsyncEnumerable<string> GenerateStreamingAsync(string systemPrompt, string userPrompt, string model, string apiKey, string baseUrl, string? imagePath = null, System.Threading.CancellationToken cancellationToken = default, System.Action<string, string, bool>? logger = null);
